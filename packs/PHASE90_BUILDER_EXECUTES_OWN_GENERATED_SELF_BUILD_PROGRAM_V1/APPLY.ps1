...
$__phase165nDynamicAdmissionPath = "self_build_programs/admission/SELF_BUILD_PROGRAM_OWNER_MATERIAL_INPUT_BOOTSTRAP_001_V1_001_ADMISSION.json"
$admission = Read-JsonRequired $__phase165nDynamicAdmissionPath
