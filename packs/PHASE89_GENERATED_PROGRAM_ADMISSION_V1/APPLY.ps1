...
param(
  ...
  [string]$RunId = "GENERATED_PROGRAM_ADMISSION_V1_001",
...
$CapabilityId = "generated_program_admission_v1"
...
function Update-Roadmap {
  ...
  Set-PropertyValue -Object $roadmap -Name "phase89_generated_program_admission_v1" -Value "COMPLETED"
...
function Update-GenesisState {
  ...
  Set-PropertyValue -Object $genesis -Name "generated_program_admission_v1" -Value "PROVEN"
  Write-JsonFile -Path "GENESIS_STATE.json" -Object $genesis
}

Write-Host "PHASE89_APPLY_START"
...
$proof = Read-JsonRequired "proofs/self_development/SELF_BUILD_PROGRAM_GENERATOR_V1.json"
if ("$(Get-PropertyValue -Object $proof -Name "status")" -ne "PASS") {
  throw "PHASE88_PROOF_NOT_PASS"
}
if ("$(Get-PropertyValue -Object $proof -Name "next_allowed_step")" -ne "PHASE89_GENERATED_PROGRAM_ADMISSION_V1") {
  throw "PHASE88_PROOF_NEXT_STEP_MISMATCH"
}

$report = & (Join-RepoPath "modules/self_development/evaluate_generated_program_admission.ps1") -RepoRoot $RepoRoot
if ($null -eq $report) {
  $report = Read-JsonRequired "reports/self_development/GENERATED_PROGRAM_ADMISSION_REPORT.json"
}
if ("$(Get-PropertyValue -Object $report -Name "status")" -ne "PASS") {
  throw "GENERATED_PROGRAM_ADMISSION_REPORT_NOT_PASS"
}
if ([bool](Get-PropertyValue -Object $report -Name "execution_performed")) {
  throw "GENERATED_PROGRAM_EXECUTION_PERFORMED_TRUE"
}
if ("$(Get-PropertyValue -Object $report -Name "next_allowed_step")" -ne $NextAllowedStep) {
  throw "GENERATED_PROGRAM_ADMISSION_NEXT_STEP_MISMATCH"
}
